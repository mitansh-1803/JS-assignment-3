var productList = [
  ...
  var clothSection = document.getElementById("clothes-section");
  var accessoriesSection = document.getElementById("accessories-section");

function addCard(source,name,brand,price) {
...
{
    console.log('mitansh');
    var card = addCard(productList[i].preview, productList[i].name, productList[i].brand, productList[i].price);
    clothSection.appendChild(card);
}
for(var i = 5; i < 10; i++)
{
    var card = addCard(productList[i].preview, productList[i].name, productList[i].brand, productList[i].price);
    accessoriesSection.appendChild(card);
}